...
class InstallTests(unittest.TestCase):
    ...
    def test_example_has_safe_requested_defaults(self) -> None:
        ...
        self.assertFalse(config["teams"]["notify_when_duration_unknown"])
        ...
        self.assertEqual(config["discord"]["minimum_seconds"], 300)
        self.assertEqual(config["discord"]["webhook_url"], "")
        self.assertEqual(config["voice"]["minimum_seconds"], 30)
        self.assertTrue(config["voice"]["notify_when_duration_unknown"])
